    ...
    <div style={{ paddingBottom: 8, display: "flex", flexDirection: "column", flex: 1, justifyContent: "flex-end" }}>
      ...
      <div style={{ display: "flex", flexDirection: "row", gap: 16, marginTop: 16 }}>
        <CButton
          ...
          className="w-full"
        />
        <button disabled={disabled} onClick={onContinue} style={{color: '#000000',background: "linear-gradient(135deg, #000000 0%, #405c57ff 25%, #E79C1C 50%, #E79C1C 75%, #6BE1DF 100%)", borderRadius: "99px", padding: "12px 24px", width: "100%"}} className="text-[#000000] rounded-full px-4 py-2">SUIVANT</button>
      </div>
    </div>
  );
};
