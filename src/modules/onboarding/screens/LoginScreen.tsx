...
export const LoginScreen: React.FC = () => {
  ...
  return (
    <Wrapper withoutTopEdge style={{ display: "flex", flexDirection: "column", gap: 12, paddingTop: 0 }}>
      <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
        ...
        <CButton buttonType="colored" text="common.connect" onClick={handleSubmit(onPressHandler)} />
